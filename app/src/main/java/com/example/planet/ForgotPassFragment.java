...
public class ForgotPassFragment extends Fragment {
    ...
    public void onStart() {
        ...
        btnReset = getView().findViewById(R.id.btnforgotpass);
        backforgot = getView().findViewById(R.id.backimgForgot);
                ...
                fbs.getAuth().sendPasswordResetEmail(etEmail.getText().toString()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(getActivity(), "Faild. Check the email address you entered!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
